...
void Logger::setControl(int32_t control) {
	m_logControl |= control;
}

void Logger::unsetControl(int32_t control) {
	m_logControl ^= control;
}

void Logger::output(LogLevel level, const char* file, int32_t line, const char * func, const char* format, ...) {
